  ...
  return (
    <section className="container mb-[24.82px] px-10 @container/cards-section md:px-20 xl:mb-8">
      <div className="flex flex-col gap-6 @[75rem]/cards-section:flex-row">
        ...
        <div className="rounded-b-2xl bg-simmer md:min-w-[544px] md:rounded-b-[20px]">
          <div className="flex justify-between gap-5 pt-[28px]">
            <div className="flex items-center rounded-r-full bg-black px-8 py-2 md:px-16 md:py-4">
              <p className="font-adelle-mono-flex leading-none text-simmer md:text-[1.5rem]">
                EXPLORE
              </p>
            </div>
        ...
        {/* card 2 */}
        <div className="w-full space-y-8 rounded-tr-[100px] bg-simmer px-[24px] py-[42px] @container/card-2 @[1400px]/cards-section:rounded-tr-[420px] md:relative md:flex md:min-h-[641px] md:flex-col md:justify-between md:px-[64px] md:pb-[64px] md:pt-[74px]">
